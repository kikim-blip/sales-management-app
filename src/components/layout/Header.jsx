      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          <div className="flex items-center space-x-2">
            <h1 className="text-lg font-bold text-slate-800 leading-tight">영업미수관리</h1>
          ...
          <p className="text-xs text-slate-500">업무 시스템</p>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        {isAdmin ? (
          ...
          <div className="flex items-center space-x-1.5 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-xl px-3 py-1.5 text-xs font-semibold text-slate-700 transition">
            ...
            <span className="hidden md:inline font-bold text-slate-600">팀</span>
            <select
