...
export default function Header() {
  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 px-3 py-2 sm:px-6 sm:py-3 flex items-center justify-between shadow-sm">
      {/* ── 좌측: 브랜드 로고 및 타이틀 ── */}
