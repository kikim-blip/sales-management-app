          ...
          <div id="printable-job-order-document" ref={printRef} className="bg-white p-2">
            ...
            <div className="border-2 border-slate-900 divide-y-2 divide-slate-900 bg-white">
              ...
              <div className="grid grid-cols-12 divide-x border-b border-slate-900 font-bold">
                ...
                <div className="col-span-10 p-2 text-rose-600 font-extrabold text-sm">{order.title}</div>
              </div>
        ...
        <div className="hidden">
          <table ref={excelTableRef} border="1">
            <tbody>
              <tr>
                <td>코드번호</td>
                <td colSpan={2}>{order.code_number}</td>
              ...
              <tr>
                <td>품 명</td>
                <td colSpan={9}>{order.title}</td>
              </tr>
              <tr>
                <td>규 격</td>
                <td colSpan={2}>{order.spec}</td>
                <td>면 수</td>
                <td colSpan={2}>{order.pages}</td>
                <td colSpan={3}>{order.duplex}</td>
              </tr>
              <tr>
                <td>수 량</td>
              ...
              <tr>
                <td>발주업체 담당자</td>
                <td colSpan={4}>{custContact} ({custPhone})</td>
                <td>이 메 일</td>
                <td colSpan={4}>{order.client_email} {order.email_receipt_time}</td>
              </tr>
              <tr>
                <td>표지작업</td>
                <td colSpan={4}>{order.cover_job}</td>
                <td>표지용지</td>
                <td colSpan={4}>{order.cover_paper}</td>
              </tr>
              <tr>
                <td>표지인쇄</td>
                <td colSpan={4}>{order.cover_print}</td>
                <td>코 팅</td>
                <td colSpan={4}>{order.coating}</td>
              </tr>
              <tr>
                <td>내지작업</td>
                <td colSpan={4}>{order.inner_job}</td>
                <td>내지용지</td>
                <td colSpan={4}>{order.inner_paper}</td>
              </tr>
              <tr>
                <td>내지인쇄</td>
                <td colSpan={4}>{order.inner_print}</td>
                <td>간지용지</td>
                <td colSpan={4}>{order.interleaf_paper}</td>
              </tr>
              <tr>
                <td>제 본</td>
                <td colSpan={4}>{order.binding}</td>
                <td>후 가 공</td>
                <td colSpan={4}>없음</td>
              </tr>
              <tr>
                <td>원 고</td>
                <td colSpan={4}>{order.draft_email} {order.draft_group} {order.mail_sender}</td>
                <td>교 정 일</td>
                <td colSpan={4}>표지: {order.cover_proof_date} / 내지: {order.inner_proof_date}</td>
              </tr>
              <tr>
                <td>교정방법</td>
                <td colSpan={4}>{order.proof_method}</td>
                <td>기 획</td>
                <td colSpan={4}>{order.planning}</td>
              </tr>
              <tr>
                <td>사진촬영</td>
                <td colSpan={4}>{order.photography}</td>
                <td>일러스트</td>
                <td colSpan={4}>{order.illustration}</td>
              </tr>
              <tr>
                <td>저작권·웹게시</td>
                <td colSpan={4}>{order.copyright_web}</td>
                <td>제작진행</td>
                <td colSpan={4}>{order.production_progress}</td>
              </tr>
              <tr>
                <td>납 품 처</td>
                <td colSpan={9}>{order.delivery_destination}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td colSpan={5}>{order.cover_related}</td>
                <td colSpan={5}>{order.inner_related}</td>
              </tr>
              <tr>
                <td>요청사항</td>
                <td colSpan={9}>{order.request_note}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>편집 작업자</td>
                <td colSpan={4}>{order.editor_name}</td>
                <td>디자인 작업자</td>
                <td colSpan={4}>{order.designer_name}</td>
              </tr>
            </tbody>
          </table>
        </div>
